...
If you get this alert, there is no need to unplug the WiFi Pineapple - simply close the tab and open a new tab to <http://172.16.42.1:1471> to continue setup! &#x20;
...
[<https://docs.hak5.org/wifi-pineapple-enterprise/setup/setup-by-usb-disk>](<https://docs.hak5.org/wifi-pineapple-enterprise/setup/setup-by-usb-disk>)
...
Once the firmware has installed, you may connect to the WiFi Pineapple network and visit the web interface at [http://172.16.42.1:1471](<http://172.16.42.1:1471 >).
...
[<https://youtu.be/LcAbDolN-v0>](<https://youtu.be/LcAbDolN-v0>)
...
> [!NOTE]
> Once the device has finished flashing, you will need to navigate to <http://172.16.42.1:1471> to complete the setup process, same as the first time you configured it!
