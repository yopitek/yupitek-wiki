...
sidebar_position: 4
description: ALFA ARS-25-57A——緊湊雙頻 2.4/5 GHz 槳形天線，5 與 7 dBi。旅行與可攜式 ALFA 設備的輕量、半指向性升級。
tags: [alfa, 天線, 槳形, 雙頻]
...
- **可攜式/滲透測試套件**——平摺、耐得住背包、鎖上任何 RP-SMA ALFA 無線網卡。
...
把 ARS-25-57A 的 RP-SMA 接頭鎖上任何 ALFA 無線網卡的 RP-SMA 天線連接埠。手指緊加上輕輕的八分之一到四分之一圈就夠了。

### 步驟 2：展開

把槳形翻開，讓它的扁平面對著你要連結的 AP/工作站。邊看無線網卡的訊號讀數邊傾斜與旋轉。
...
- **雙天線無線網卡**：在 AWUS036ACM/ACH 上你可以一支用槳形、一支留在 5 GHz——但對多頻段連結，兩支天線都應瞄準相同頻段以獲得一致的 MIMO。
...
| 搭配 | 結果 |
|---|---|
| 任何配 RP-SMA 天線連接埠的 ALFA 無線網卡 | ✅ 直接鎖上 |
...
| 自己摺回去 | 鉸鏈摩擦磨損 | 輕微問題——靠無線網卡自身重量維持方向是正常的 |
