...
title: 變更紀錄
sidebar_position: 6
description: Yupitek Wiki 重大變更的依時間順序紀錄。
---

# 變更紀錄

本紀錄記錄 Yupitek Wiki 的重大變更。最新的條目在最上方。

## 2026-08-21 — 第一階段（英文來源內容）
...
- 為全部 5 個品牌撰寫完整的**英文來源**內容：
  ...
  - **ACS** — 索引與 3 個智慧卡讀卡機產品頁面。
- 新增**快速入門**頁面：FAQ、支援政策與詞彙表。
- 新增**管理**頁面：產品登記表、驅動程式登記表、翻譯詞彙表、範本、審查佇列與本變更紀錄。
- 設定 3 個 Cloudflare Pages 部署工作流程（`en` / `zh-cn` / `zh-tw`）。
