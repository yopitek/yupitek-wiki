...
description: 官方 Flipper Zero 資源的精選索引 — 官方網站、檔案、GitHub 上的韌體原始碼、qFlipper、手機應用程式、電路圖、社群頻道與支援。
sidebar_position: 4
...
> **學習目標**：這個頁面是關於 Flipper Zero 一切官方資訊的單一書籤——公司網站、檔案、原始碼、工具，以及尋求協助的地方。把它加入書籤吧。
...
| 官方檔案 | https://docs.flipper.net | 使用者指南、開發者檔案、硬體檔案 |
...
| [Flipper Zero 電路圖與硬體](https://docs.flipper.net) | 官方檔案提供 GPIO 接腳定義與電路圖 PDF |
...
> ⚠️ **購買者請注意**：只從官方 GitHub 組織或官方應用程式商店下載韌體與應用程式。「Flipper」仿冒網站與第三方韌體包曾被用來散佈惡意軟體。
